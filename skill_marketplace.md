...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `agent-skills-hub-agent-skills-hub-ui-ux-designer`                                |
| Version    | 1.0.1                                     |
...
**GitHub:** [agent-skills-hub/agent-skills-hub](https://github.com/agent-skills-hub/agent-skills-hub) — ⭐ 5 | Forks: 3
...
This Skill is an expert UI/UX design assistant for creating and maintaining accessible, tokenized design systems, wireframes, and validated user experiences. Use it for atomic design architecture, design token creation and management (Figma Variables, Style Dictionary), component library design, multi‑brand scaling, versioned governance, and design-to-development handoff optimization (Storybook, Chromatic). It provides guidance on Figma advanced workflows (Auto Layout, Variants, Variables), prototyping with interactions and micro-animations, asset generation, and developer collaboration. Typical use cases include building or auditing design systems, running accessibility reviews, defining design tokens, mapping user flows, and producing handoff artifacts and checklists. Core advantages are consistent cross-platform UI, faster iteration, scalable maintenance, inclusive design outcomes, and actionable verification steps (see resources/implementation-playbook.md for implementation examples).
...
```bash
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-ui-ux-designer
```
...
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-ui-ux-designer --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-ui-ux-designer --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-ui-ux-designer --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-ui-ux-designer --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-ui-ux-designer --version 1.0.1
```
...
```bash
npx -y @lobehub/market-cli skills rate agent-skills-hub-agent-skills-hub-ui-ux-designer --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment agent-skills-hub-agent-skills-hub-ui-ux-designer -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment agent-skills-hub-agent-skills-hub-ui-ux-designer
```
...
```bash
npx -y @lobehub/market-cli skills comments agent-skills-hub-agent-skills-hub-ui-ux-designer
```
